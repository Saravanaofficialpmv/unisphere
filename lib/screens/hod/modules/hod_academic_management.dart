...
class HodAcademicManagement extends StatelessWidget {
  ...
  Widget _buildAcademicGrid(BuildContext context) {
    final items = [
      ...
      {'title': 'Subject Allocation', 'sub': 'Core & Elective Subject Lists', 'icon': Icons.menu_book_outlined, 'color': const Color(0xFF059669)},
      ...
      {'title': 'Semester Planning', 'sub': 'Syllabus Coverage Tracking', 'icon': Icons.edit_calendar_outlined, 'color': const Color(0xFF0891B2)},
  ...
  Widget _buildActionButtons(BuildContext context) {
    return Wrap(
      ...
      children: [
        ...
        _buildActionButton(context, Icons.add_circle_outline, 'Create Subject', () => _showDialogMsg(context, 'Create New Subject')),
        ...
        _buildActionButton(context, Icons.collections_bookmark_outlined, 'Manage Curriculum', () => _showDialogMsg(context, 'Manage Department Curriculum')),
