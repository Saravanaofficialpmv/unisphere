...
/// Opens the floating student navigation launcher sheet.
Future<void> showStudentNavigationSheet({
  ...
  return showModalBottomSheet(
    ...
    builder: (ctx) => StudentNavigationSheet(
...
class StudentNavigationSheet extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<StudentNavigationSheet> createState() => _StudentNavigationSheetState();
}

class _StudentNavigationSheetState extends ConsumerState<StudentNavigationSheet> {
  ...
  /// Groups items by their section header.
